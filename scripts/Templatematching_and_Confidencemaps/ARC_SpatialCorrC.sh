...
subjects_file=/bulk/bray_bulk/Shefali_PreciseKIDS/datalist_child_dconn.txt #all children except 003C
...
echo "Starting SpatialCorr for each child at `date`"

matlab -nodisplay -nodesktop -nosplash -r "arc_SpatialCorrC('$SCDIR/MSCAveraged_Timeseries.dconn.nii', '$MATDIR/${subject}_${tasks}_sample1_censored.dconn.nii', '${subject}', '${tasks}')"

echo "Finished SpatialCorr for each child at `date`"
