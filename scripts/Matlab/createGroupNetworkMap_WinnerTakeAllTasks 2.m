function createGroupNetworkMap_WinnerTakeAllTasks(inputDir, outputDir)
%
...
% OR '/Users/shefalirai/Desktop/Exemplar_Prckids'
%
...
files = dir(fullfile(inputDir, '*task-DORA_HCPAdultChild_overlap_14networkassignment_Vertexwise_Exemplar_alldicevalues_network1.dscalar.nii'));
...
for i = 1:length(files)
    ...
    % Define full subject ID strings as they appear in filenames
    allowedAdults = {'sub-1973002P', 'sub-1973006P', 'sub-1973007P', 'sub-1973010P', ...
                 'sub-1973011P', 'sub-1973016P', 'sub-1973021P', 'sub-1973023P'};

    for subj = allowedAdults
            if contains(files(i).name, subj{1})
...
% Write output files
try
    ft_write_cifti_mod(fullfile(outputDir, 'ExemplarAdults_groupaverage_task-DORA_HCPAdultChildoverlap_14networkassignment_network1.dscalar.nii'), adultOut);
