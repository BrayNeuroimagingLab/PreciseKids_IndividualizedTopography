function fc_table = ARC_Extract_MeanFC_PKids_individualmaps(subject, dconn_dir, dscalar_dir, distmat_file, network_labels, dist_thresh_mm)
...
for i = 1:length(network_labels)
    ...
    for j = i:length(network_labels)
        ...
        mean_fc = ARC_Extract_PairwiseFC_censored_individualmaps( ...
                dconn_file, dscalar_file, netA, netB, distmat_file, dist_thresh_mm);
...
save(fullfile(dconn_dir, [subj '_fc_table_leftover15min_individualmaps.mat']), 'fc_table');
