function arc_IDvariants_Sample1P(spatialCorrMap, subID, task, snrMask,corrThresh,sizeThresh)
...
neighLoc = '/bulk/bray_bulk/Shefali_PreciseKIDS/spatialcorr';
...
if ~exist('outputdir')
    outputdir = '/bulk/bray_bulk/Shefali_PreciseKIDS/spatialcorr';
end
...
ft_write_cifti_mod(sprintf([outputdir '/%s_%s_binarySpatialCorrMap_thresh' num2str(variantThresh) '%.dtseries.nii'], subID, task), template);
