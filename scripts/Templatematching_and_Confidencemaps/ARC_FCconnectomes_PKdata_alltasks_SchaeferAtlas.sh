...
matlab -nodisplay -nodesktop -nosplash -r "ARC_Extract_MeanFC_PKids_SchaeferAtlas('${subject}', '${MATDIR}', '${MATDIR}/Schaefer2018_1000Parcels_17Networks_order.dscalar.nii', '${MATDIR}/Conte_DISTANCE_32k_fsLR-001.mat', 1:1000, 0.3); exit;"
