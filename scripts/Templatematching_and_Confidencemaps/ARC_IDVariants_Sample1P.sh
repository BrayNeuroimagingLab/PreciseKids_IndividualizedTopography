...
subjects_file=/bulk/bray_bulk/Shefali_PreciseKIDS/datalist_parent_dconn.txt #all parents
...
echo "Starting IDVariants for each parent at `date`"
matlab -nodisplay -nodesktop -nosplash -r "arc_IDVariants_Sample1P('$SCDIR/${subject}_${tasks}_sample1_spatialCorrMap.dtseries.nii', '${subject}', '${tasks}')"


echo "Finished IDVariants for each parent at `date`"
