function ARC_Templatematching_PKdata_alltasks_only30min_v2(subject, task)
...
%Get dconn
connFile = sprintf('/bulk/bray_bulk/Shefali_PreciseKIDS/newmc_matlabdir/%s_%s_only30min.dconn.nii', subject, task);
...
sub_data=ciftiopen(sprintf('/bulk/bray_bulk/Shefali_PreciseKIDS/newmc_matlabdir/%s_%s_sample1_only30min.dtseries.nii', subject, task), wbcommand);
sub_data.cdata=assignedNetwork;
outputFile = sprintf('/bulk/bray_bulk/Shefali_PreciseKIDS/newmc_matlabdir/%s_%s_HCPAdultChild_overlap_only30min_Dice.dscalar.nii', subject, task);
