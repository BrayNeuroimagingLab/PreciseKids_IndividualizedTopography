...
subjects_file=/bulk/bray_bulk/Shefali_PreciseKIDS/datalist.txt #excludes 003 family
...
echo "Starting FC connectomes for vertex wise data at `date`"

matlab -nodisplay -nodesktop -nosplash -r "ARC_Extract_MeanFC_PKids_grouptemplate('${subject}', '${MATDIR}', '${MATDIR}/Alladults_groupaverage_winnertakeall_alltasks_HCPAdultChild_overlap_14networkassignment.dscalar.nii', '${MATDIR}/Allchildren_groupaverage_winnertakeall_alltasks_HCPAdultChild_overlap_14networkassignment.dscalar.nii', '${MATDIR}/Conte_DISTANCE_32k_fsLR-001.mat', 1:16, 0.3); exit;"

echo "Finished FC connectomes for vertex wise data at `date`"
