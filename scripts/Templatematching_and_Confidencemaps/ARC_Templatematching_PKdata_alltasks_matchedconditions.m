function ARC_Templatematching_PKdata_alltasks_matchedconditions(subject, task)
...
%Create dconn
file_path = sprintf('/bulk/bray_bulk/Shefali_PreciseKIDS/newmc_matlabdir/%s_%s_sample1_censored.dtseries.nii', subject, task);
...
outputFile = sprintf('/bulk/bray_bulk/Shefali_PreciseKIDS/newmc_matlabdir/%s_%s_MSCavgtemplatematching_14networkassignment_Vertexwise_sample1_matchedconditions.dscalar.nii', subject, task);
