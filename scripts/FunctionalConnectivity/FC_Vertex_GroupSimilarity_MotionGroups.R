...
for (method_name in names(fc_by_method)) {
  ...
  group_similarity[[method_name]] <- bind_rows(lma_result, lmc_result)
}
...
ggsave("/Users/shefalirai/Downloads/FC_Vertex_Connectomes/FC_GroupSimilarity_2groups.svg",
