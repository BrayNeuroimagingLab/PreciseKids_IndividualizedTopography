...
subjects_file=/bulk/bray_bulk/Shefali_PreciseKIDS/datalist_child_dconn.txt #excludes 003C
...
echo "Starting Confidence measures for PK Child data vertex wise at `date`"

matlab -nodisplay -nodesktop -nosplash -r "ARC_ConfidenceMaps_PKdata_alltasks_Sample2('${subject}', '${task}')"

echo "Finished Confidence measures for PK Child data vertex wise at `date`"
