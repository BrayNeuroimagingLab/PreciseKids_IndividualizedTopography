...
echo "Starting IDVariants for each child at `date`"

matlab -nodisplay -nodesktop -nosplash -r "arc_IDVariants_Sample1C('$SCDIR/${subject}_${tasks}_sample1_spatialCorrMap.dtseries.nii', '${subject}', '${tasks}')"

echo "Finished IDVariants for each child at `date`"
