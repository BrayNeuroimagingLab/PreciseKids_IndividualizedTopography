...
matlab -nodisplay -nodesktop -nosplash -r "ARC_Extract_MeanFC_PKids_highconfidence('${subject}', '${MATDIR}', '${MATDIR}', '${MATDIR}/Conte_DISTANCE_32k_fsLR-001.mat', 1:16, 30, 0.3); exit;"
